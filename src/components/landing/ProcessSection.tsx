...
const ProcessSection = () => {
  ...
  return (
    <section id="process" className="relative py-24 md:py-32 bg-background overflow-hidden">
      {/* Glow orbs */}
      <div className="absolute top-1/4 -left-32 w-[500px] h-[500px] bg-primary/6 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-32 w-[400px] h-[400px] bg-secondary/6 rounded-full blur-[120px] pointer-events-none" />

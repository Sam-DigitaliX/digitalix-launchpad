    ...
    <section className="relative min-h-[calc(100vh-80px)] flex items-center justify-center overflow-hidden pt-20 pb-28 md:pb-32">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight md:leading-relaxed text-foreground mb-6 animate-fade-in-up animation-delay-100">
          ...
          <p className="text-lg md:text-xl text-foreground max-w-2xl mx-auto mb-10 animate-fade-in-up animation-delay-200 leading-relaxed">
            ...
            <span className="block mt-4 text-muted-foreground font-light">
              Aujourd'hui, le tracking classique ne suffit plus
              <br />
              à garantir la maîtrise des données.
            </span>
